...
class Board(object):
    ...
    def current_state(self):
        ...
        square_state = np.zeros((self.width, self.height),dtype=int)
        if self.states:
            ...
            square_state[move_oppo // self.width,
                            move_oppo % self.height] = (1 if self.current_player == 2 else 2)
    ...
    def step(self, move):
        ...
        return self.current_state(),r,t,None
