...
class H3_net(nn.Module):
    ...
    def forward(self,ind,attri_stack,planes_stack,plane_glb,critic_only = False):
        ...
        h,target_embs = self.inpipe(ind_t,attri_stack_t,planes_stack_t,plane_glb_t)
        value = self.critic(h)
        if critic_only:
            return value
        ...
        return act_logits,targets_logits,target_embs,position_logits,spell_logits,value
