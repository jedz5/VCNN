...
from discrete_net import Net, Actor, Critic,H3_policy
import gym
...
def test_ppo(args=get_args()):
    ...
    train_envs = env
    test_envs = env
    # train_envs = VectorEnv([lambda: create_atari_environment(
    #     args.task, max_episode_steps=args.max_episode_steps)
    #     for _ in range(args.training_num)])
    # # test_envs = create_atari_environment(
    # #     args.task, max_episode_steps=args.max_episode_steps)
    # test_envs = VectorEnv([lambda: create_atari_environment(
    #     args.task, max_episode_steps=args.max_episode_steps)
